(function () {
    ...
    var Pivot2 = {
        ...
        // ── Context Menu Event Dispatch ──
        // Emits a CustomEvent so the host application can wire its own context menu.
        // The library stays decoupled: it only dispatches, never imports host code.
